...
1. **Giriş ve Çalışma Ortamı**
   ...
   * **Referans Notu:** *(Bkz. Ek A: C# Sürüm Özellikleri)*
...
2. **Temel Programlama Kavramları**
   ...
   * **Referans Notu:** *(Bkz. Ek B: Veri Tipleri ve Bellek Boyutları)*
...
## **Bölüm 3 – Diziler ve Koleksiyonlar**
...
## **Bölüm 4 – Metotlar ve Parametreler**
...
## **Bölüm 5 – Nesne Tabanlı Programlama (OOP)**
...
## **Bölüm 7 – Asenkron ve Paralel Programlama**
...
## **Bölüm 8 – Dosya ve Veri İşlemleri**
...
## **Bölüm 9 – Veritabanı ile Çalışma**
...
* **Ek A:** C# Sürüm Özellikleri Tablosu
* **Ek B:** Veri Tipleri ve Bellek Boyutları (short, int, long, float, double, decimal, bool, char, string)
* **Ek C:** Operatörler Tablosu
* **Ek D:** Erişim Belirleyiciler Tablosu (public, private, protected, internal)
* **Ek E:** Koleksiyonlar Karşılaştırma Tablosu (List, Dictionary, Queue, Stack)
* **Ek F:** LINQ Metotları Referansı
* **Ek G:** Async/Await Kullanım Örnekleri
* **Ek H:** Entity Framework Core Migration Komutları
* **Ek I:** HTTP Durum Kodları Tablosu
